...
# Initialize sample data@app.on_event("startup")
    ...
    sample_quizzes = [
        {
            ...
            "questions": [
                ...
                {
                    "question": "How often is it hard to relax?",
                    "options": ["Never", "Sometimes", "Often", "Always"],
                    "type": "multiple_choice"
                },
                {
                    "question": "Does worry keep you away from social activities?",
                    "options": ["Never", "Sometimes", "Often", "Always"],
                    "type": "multiple_choice"
                },
                {
                    "question": "Has worry disrupted your sleep or rest?",
                    "options": ["Never", "Sometimes", "Often", "Always"],
                    "type": "multiple_choice"
                },
                {
                    "question": "Have you experienced any physical symptoms of anxiety?",
                    "options": ["Never", "Sometimes", "Often", "Always"],
                    "type": "multiple_choice"
                },
                {
                    "question": "Do you avoid places because they feel unsafe?",
                    "options": ["Never", "Sometimes", "Often", "Always"],
                    "type": "multiple_choice"
                },
                {
                    "question": "Do you expect something bad to happen soon?",
                    "options": ["Never", "Sometimes", "Often", "Always"],
                    "type": "multiple_choice"
                }
            ],
